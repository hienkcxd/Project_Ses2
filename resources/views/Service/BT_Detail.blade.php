            ...
            <div class="row">
                <div id="sidebar" class="col-md-3 wow fadeInUp">
                    <ul id="services-list">
                        ...
                        <li class="active"><a href="{{ route('Service_BT') }}">BIỆT THỰ</a></li>
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-6 wow fadeInUp" data-wow-delay=".3s">
                            <p>Giá thiết kế kiến trúc trên thị trường giao động từ <b>2000.000 đến 400.000 VND/m<sup>2</sup></b>.</p>
                            <p>Đối với đơn giá thi công phần thô và kiến trúc có nhiều yếu tố tác động, ví dụ như địa hình: vị trí trong hẻm hay đường lớn,
                                ...
                                Giá giao động từ <b>7.000.000 đến 9.000.000 VNĐ</b></p>
