            ...
            <div class="row">
                <div id="sidebar" class="col-md-3 wow fadeInUp">
                    <ul id="services-list">
                        ...
                        <li class="active"><a href="{{ route('Service_canho') }}">DECOR CĂN HỘ</a></li>
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-6 wow fadeInUp" data-wow-delay=".3s">
                            <p>Giá thiết kế kiến trúc trên thị trường giao động từ <b>160.000 đến 250.000 VND/m<sup>2</sup></b>.</p>
                            <p>Đối với đơn giá thi công phần thô và kiến trúc có nhiều yếu tố tác động, ví dụ như địa hình: vị trí trong hẻm hay đường lớn,
                                ...
                                Giá giao động từ <b>2.000.000 đến 4.000.000 VNĐ</b></p>
                        ...
                        <div class="col-md-6 pic-services wow fadeInUp" data-wow-delay=".6s">
                            <img src="{{ asset('images/services/p2_a.jpg') }}" class="img-responsive" alt="">
                            <img src="{{ asset('images/services/p2_b.jpg') }}" class="img-responsive" alt="">
                        </div>
                    </div>
                </div>
