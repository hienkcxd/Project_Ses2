    ...
    public function run()
    {
        DB::table('news_lists')->insert([
            ['NewsID' => 'N01', 'NewsName' => 'Forest House - Ngôi nhà trong mơ của những người yêu thiên nhiên',
                ...
                'Day' => '25/02','Year' => '2021',
                'images' => 'http://127.0.0.1:8000/storage/uploads/News_bg_01_1622984537.jpg'],
            ...
            ['NewsID' => 'N02', 'NewsName' => 'GỖ - Người bạn đa năng trong ngôi nhà',
                ...
                'Day' => '18/08','Year' => '2020',
                'images' => 'http://127.0.0.1:8000/storage/uploads/News_bg_02_1622983632.jpg'],
            ...
            ['NewsID' => 'N03', 'NewsName' => 'Hãy chọn ghế đúng',
                ...
                'Day' => '09/07','Year' => '2020',
                'images' => 'http://127.0.0.1:8000/storage/uploads/News_bg_03_1622982711.jpg'],
            ...
            ['NewsID' => 'N04', 'NewsName' => '5 cách tạo nên phòng ngủ ấm áp',
                ...
                'Day' => '07/07','Year' => '2020',
                'images' => 'http://127.0.0.1:8000/storage/uploads/News_bg_04_1622983406.jpg'],
            ...
            ['NewsID' => 'N05', 'NewsName' => 'Từng bước trang trí căn phòng Vintage mơ ước',
                ...
                'Day' => '23/06','Year' => '2020',
                'images' => 'http://127.0.0.1:8000/storage/uploads/News_bg_05_1622982960.jpg'],
            ...
            ['NewsID' => 'N06', 'NewsName' => 'Đặc điểm văn phòng phong cách đương đại',
                ...
                'Day' => '19/06','Year' => '2020',
                'images' => 'http://127.0.0.1:8000/storage/uploads/News_bg_06_1622984748.jpg'],
            ...
            ['NewsID' => 'N07', 'NewsName' => 'Stylish phòng khách hiện đại cho mọi đối tượng',
                ...
                'Day' => '06/05','Year' => '2020',
                'images' => 'http://127.0.0.1:8000/storage/uploads/News_bg_07_1622984768.jpg'],
